<?php
    ...
    //numero de pagina en la que el usuario se encuentra.
    #si no hay ningun valor entonces le asignamos la pagina 1.
    $pagina = isset($_GET['pagina']) ? (int)$_GET['pagina'] : 1;

    //Establecemos cuantos post por pagina queremos cargar.
    $postPorPagina = 3;

    //Revisamos desde que articulo vamos a cargar, dependiendo en la que se encuentre el usuario.
