<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_FILES)) {
        //getimagesize retorna arreglo de propiedades de la imagen y si no es imagen retorna false y error notice.
        //el @ de la funcion omite el notice si no es una imagen.
